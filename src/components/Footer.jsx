...
const Footer = () => {
  return (
    <div className="pt-8  pt-9 bg-[#faebd7]">
      <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
          ...
          <div className="md:w-[316px]">
            <p className="text-[18px] font-medium ">
              <h1 className=" font-extrabold flex items-center">
                ...
                <span className="text-[#2fff2f]">LIME</span>LIGHT
              </h1>
            </p>
            <p className="mt-[18px] text-[15px]  ">
            Discover Limelight, your all-in-one solution for illuminating your moments. With its cutting-edge technology and sleek design, Limelight redefines how you experience light. Illuminate your world with Limelight and let your creativity shine.
            </p>
        ...
        <div class="mt-[23px] flex">
          ...
          <div class="ml-[18px]">
            <a href="tel:+911800123444" class="font-Inter text-[14px] font-medium ">+91 1800123444</a>
        ...
        <div class="mt-[23px] flex">
          ...
          <div class="ml-[18px]">
            <a href="mailto:help@lorem.com" class="font-Inter text-[14px] font-medium ">help@lorem.com</a>
        ...
        <div class="mt-[23px] flex">
          ...
          <div class="ml-[18px]">
            <a href="mailto:help@lorem.com" class="font-Inter text-[14px] font-medium ">Sub Nerul, Mumbia,
              India, 123456</a>
      ...
      <div class="mt-6 flex w-full flex-col justify-between  sm:flex-row md:mt-0 md:max-w-[341px]">
        ...
        <hr className="mt-[30px] border-0 bg-black h-px" />
        <div className="flex items-center justify-center pb-8 pt-[9px] md:py-8">
          <p className="text-[10px] font-bold md:text-[12px]">
            © Copyright
            {/* -->2024 */}
            , All Rights Reserved by LIMELIGHT. PVT. LTD
          </p>
        </div>
      </div>
    </div>
